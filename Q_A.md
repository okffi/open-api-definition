...
Hyvä tapa on ensin julkaista avoin data tiedostona. Sen jälkeen kerätä sen käyttäjätarinat ja suunnitella ohjelmistorajapinta käyttötarinoiden perusteella. Ohjelmistorajapintaa voi versioida ja laajentaa tukemaan erilaisia käyttötapauksia. Tärkeää on, että ohjelmistorajapinta on toteutettu vastaamaan sen käyttötapauksia, koska muuten sen käyttö on työlästä, eikä yleensä huokuttele ohjelmistokehittäjiä. Huonosti käyttötapaukseen sopivassa ohjelmistorajapinnassa voidaan esimerkiksi joutua suorittamaan suuri määrä kutsuja ohjelmistorajapinnalle. 
